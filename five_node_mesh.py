...
# Specify Code Path
codePath = '/users/pkethe/Integration/';
dataPath = '/users/pkethe/Integration/data/';
...
mnlrTierAddress.append('1.5')               #node5

# Assign End Network Node IDS
endNWNodeIDS =[2,3,5];
endNWIPS = ['10.1.4.2','10.1.1.2', '10.1.8.2'];
endNWCIDR = ['24','24', '24']
endInterfaces =[];
endNodeSSH = [];
...
for i in range(0, numOfMNLRNodes):
    ...
    sys.stdout.flush();
    ssh[i].connect(hostNames[i], port=22, username='pkethe', password='Enter Password');
